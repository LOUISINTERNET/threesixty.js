...
var ThreeSixty = /*#__PURE__*/function () {
  ...
  _createClass(ThreeSixty, [{
    ...
    value: function next() {
      ...
      var nextEvent = new Event('threesixty:next');
    ...
    value: function prev() {
      this["goto"](_classPrivateFieldGet(this, _options).inverted ? _classPrivateFieldGet(this, _index) + 1 : _classPrivateFieldGet(this, _index) - 1);
      var prevEvent = new Event('threesixty:prev');
    ...
    value: function goto(index) {
      ...
      this._update();
      var gotoEvent = new Event('threesixty:goto');
    ...
    value: function play(reversed, maxloops) {
      ...
      this.nloops = 0;
      var playEvent = new Event('threesixty:play');
    ...
    value: function stop() {
      ...
      this.nloops = 0;
      var stopEvent = new Event('threesixty:stop');
